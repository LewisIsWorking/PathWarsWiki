...
> The routes have their own page.
>> - See [Crystron Trains combos](Crystron-trains-combos.md).
>> - Every route there is MACHINE CHECKED against the ruleset by `tools/combo`.
>> - Starter quality, the two-card upgrades and the traps to avoid live there too.
