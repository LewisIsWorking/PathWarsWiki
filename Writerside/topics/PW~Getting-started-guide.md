...
- You don't need to make a deep backstory. It is appreciated but definitely not required!
...
Read = [Spoiler-avoidance-guide.md](PW~Spoiler-avoidance-guide.md)
...
- [Build YOUR Character’s Life HERE! Character-Lore-Builder.md](PW~Character-Lore-Builder.md)

If you need information on the world, check out:
- [Golarion-Lore-The-Spoiler-Free-Version](PW~Golarion-Lore-The-Spoiler-Free-Version.md)
...
- [Homebrew Rule Changes.](PW~Homebrew-rules.md)
...
Check out my 5 plot threads rule on: [Homebrew-rules.md](PW~Homebrew-rules.md).
...
- [Path Builder 2e.](PW~Pathbuilder-setup.md)
...
- [Pathbuilder-setup.md](PW~Pathbuilder-setup.md)
...
- [3rd-party-content-and-options.md](PW~3rd-party-content-and-options.md)
...
- [Rarity-Lock-Status-Tracker.md = Uncommon/Rare/Unique.](PW~Rarity-lock-status-tracker.md)
...
[Lore Increases in Homebrew-rules.md](PW~Homebrew-rules.md)
