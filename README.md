...
PathWarsWiki/
├── Writerside/
│   ├── topics/           # All wiki content organized by category
│   │   ├── C01-Doomsday-Funtime/    # Campaign 1 specific content
│   │   ├── Cross-campaign lore/      # Shared world information
│   │   ├── Extra-rules/              # Custom rules and systems
│   │   ├── Info/                     # Player guides and setup
│   ���   ├── Main-Characters/          # Primary character profiles
│   │   ├── Side-Characters/          # Supporting character info
│   │   ├── Other-campaigns/          # Additional campaign data
│   │   └── Random/                   # Miscellaneous content
│   ├── images/           # Visual assets, maps, and reference images
│   ├── cfg/              # Writerside configuration files
│   ├── *.tree           # Navigation structure definitions
│   └── writerside.cfg   # Main configuration file
├── README.md            # This comprehensive guide
└── qodana.yaml         # Code quality and validation settings
```
